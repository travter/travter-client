...
class JourneyFormEvent with _$JourneyFormEvent {
  ...
  const factory JourneyFormEvent.visitedPlacesChanged(List<String> places) =
      VisitedPlacesChanged;
  const factory JourneyFormEvent.descriptionChanged(String description) =
      DescriptionChanged;
